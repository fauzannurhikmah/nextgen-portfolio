...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-[160px] px-[5vw] max-w-[1300px] mx-auto" ref={ref}>
      ...
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-px border border-[var(--border)]"
      >
        {experiences.map((exp, i) => (
          ...
          >
            ...
            <div className="font-mono text-[10px] tracking-[.18em] uppercase text-[var(--muted)] mb-1.5">
              {exp.period}
            </div>
            <div
              className="inline-block px-3 py-1 mb-5 font-mono text-[10px] tracking-[.1em] text-[var(--accent)]"
              style={{ background: 'rgba(232,255,71,.08)', border: '1px solid rgba(232,255,71,.2)' }}
            >
              {exp.company}
            </div>
            <div className="text-[22px] font-semibold text-[var(--cream)] mb-3 leading-[1.2]">
              {exp.role}
            </div>
